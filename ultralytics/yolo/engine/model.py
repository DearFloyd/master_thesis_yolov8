...
class YOLO:
    ...
    @smart_inference_mode()
    def predict(self, source=None, verbose_path=None, stream=False, **kwargs):
        """
        ...
        return self.predictor.predict_cli(source=source, verbose_path=verbose_path) if is_cli else self.predictor(source=source, verbose_path=verbose_path, stream=stream)
