...
def parse_opt():
    ...
    parser.add_argument('--name', type=str, default='test_11_14', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true", help='show results if possible')
    parser.add_argument('--save_verbose', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/test_11_14/verbose.txt', help='save detail predict verbose results as .txt file')
