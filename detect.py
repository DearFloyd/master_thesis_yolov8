...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/train/yolov8s-LRMSC-BRA/weights/best.pt', help='training model path')
    ...
    parser.add_argument('--name', type=str, default='test_12_25', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true", help='show results if possible')
    parser.add_argument('--save_verbose', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/test_12_25/verbose.txt', help='save detail predict verbose results as .txt file')
    ...
    parser.add_argument('--vid_stride', type=int, default=30, help='video frame-rate stride')
