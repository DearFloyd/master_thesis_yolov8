...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/workspace/cv-docker/joey04.li/datasets/video_data/10.22-raw-split2.mp4', help='source directory for images or videos')
    ...
    parser.add_argument('--name', type=str, default='test_12_29_2', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true", help='show results if possible')
    parser.add_argument('--save_verbose', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/test_12_29_2/verbose.txt', help='save detail predict verbose results as .txt file')
