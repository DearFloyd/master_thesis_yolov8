...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/src_img/split_output1.mp4', help='source directory for images or videos')
    ...
    parser.add_argument('--name', type=str, default='test_01_04_15min_example', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true", help='show results if possible')
    parser.add_argument('--save_verbose', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/test_01_04_15min_example/verbose.txt', help='save detail predict verbose results as .txt file')
