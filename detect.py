...
def parse_opt():
    ...
    parser.add_argument('--name', type=str, default='sp6', help='experiment name (project/name)')
    parser.add_argument('--show', action="store_true", help='show results if possible')
    parser.add_argument('--save_verbose', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/sp6/verbose.txt', help='save detail predict verbose results as .txt file')
    ...
    parser.add_argument('--grid_classify', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/runs/detect/sp6', help='grid classify record dir')
