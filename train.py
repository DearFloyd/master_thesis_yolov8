...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/ultralytics/models/v8/yolov8s.yaml', help='model.yaml path')
    ...
    parser.add_argument('--device', type=str, default='5', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--workers', type=int, default=8, help='max dataloader workers (per RANK in DDP mode)')
    parser.add_argument('--project', type=str, default=ROOT / 'runs/train', help='save to project/name')
    parser.add_argument('--name', type=str, default='yolov8s-164bs-500ep', help='save to project/name')
