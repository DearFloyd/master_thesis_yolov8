...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/ultralytics/models/v8-thesis/yolov8s-C2f-EMSC-attention-head-.yaml', help='model.yaml path')
    ...
    parser.add_argument('--data', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/dataset/classroom_data_old.yaml', help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='yolov8s-C2f-EMSC-attention-head--164bs-500ep', help='save to project/name')
    ...
    parser.add_argument('--profile', default=True, help='profile ONNX and TensorRT speeds during training for loggers')
