...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='/workspace/cv-docker/joey04.li/datasets/master_thesis_yolov8/ultralytics/models/v8/yolov8s-C2f-EMSC-diff-position.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', type=str, default='yolov8s-C2f-EMSC-diff-position-164bs-500ep', help='save to project/name')
